...
echo "====================================="
for disk in $(df -h | grep "\/dev\/sda" | awk '{print $1}')
do
percentage_use=$(df -h | grep "\/dev\/sda" | awk '{print $5}')
total_disk_space=$(df -h | grep "\/dev\/sda" | awk '{print $2}')
actual_disk_usage=$(df -h | grep "\/dev\/sda" | awk '{print $3}')
actual_disk_unused=$(df -h | grep "\/dev\/sda" | awk '{print $4}')
